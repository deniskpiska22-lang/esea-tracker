// Единый источник данных команд.
// Чтобы обновить рейтинг:
// 1. Измени только поле points у нужной команды.
// 2. Запусти: npm run rankings:update
// Скрипт автоматически обновит teamHistory.json и rankingSnapshot.json.
...
const teams = [
...

  {
    ...
    players: ["d3nks", "maun", "-FlyTex", "hyp3else66", "xdxdxxdxxdd"],
    matches: [],
  },
      {
    slug: "mellren",
